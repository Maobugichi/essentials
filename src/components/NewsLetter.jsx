const NewsLetter = () => {
    return(
        <div className=" flex lg:flex-row flex-col lg:h-1/2 h-[90%] w-full gap-5  text-center">
            <div className="lg:w-1/2 w-full grid">
                <h3 className="text-2xl">Join Our Community</h3>
                <p className="lg:w-[70%] w-[90%] mx-auto lg:text-sm text-[12px] text-[#212121cc]">Be the first to get the latest updates on our promotion campaigns, products and services.</p>
            </div>
