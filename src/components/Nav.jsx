...
const Nav = ({ text,isStuck,setIsStuck , amount , color, iconColor , cartColor,cartText , openNav, setOpenNav , showCart, setShowCart}) => {
  ...
  const collections = {
  "All":[{name: "Essentials Backpack", src: bag20, bestSelling: true, price: 80000, date: "2024-09-10", size: ["One Size"], onSale: false, capacity: "20L", material: "Nylon", color: ["Black", "Grey"], amount: 50},
    {name: "Essentials Duffel Bag", src: bag3, bestSelling: false, price: 60000, date: "2024-07-15", size: ["Small", "Medium", "Large"], onSale: true, capacity: "30L", material: "Polyester", color: ["Navy Blue", "Red"], amount: 30},
    {name: "Essentials Gym Bag", src: bag21, bestSelling: true, price: 70000, date: "2024-08-20", size: ["One Size"], onSale: false, capacity: "25L", material: "Nylon", color: ["Black", "Green"], amount: 40},
   ...
   {name: "Essentials Leggings", src: pant18, bestSelling: false, price: 40000, date: "2024-08-20", size: ["Small", "Medium", "Large"], onSale: true, material: "Cotton", color: ["Black", "Grey"], amount: 45},
    ...
    "Bag": [
          {name: "Essentials Backpack", src: bag20, bestSelling: true, price: 80000, date: "2024-09-10", size: ["One Size"], onSale: false, capacity: "20L", material: "Nylon", color: ["Black", "Grey"], amount: 50},
          {name: "Essentials Duffel Bag", src: bag3, bestSelling: false, price: 60000, date: "2024-07-15", size: ["Small", "Medium", "Large"], onSale: true, capacity: "30L", material: "Polyester", color: ["Navy Blue", "Red"], amount: 30},
          {name: "Essentials Gym Bag", src: bag21, bestSelling: true, price: 70000, date: "2024-08-20", size: ["One Size"], onSale: false, capacity: "25L", material: "Nylon", color: ["Black", "Green"], amount: 40},
          {name: "Essentials Tote Bag", src: bag4, bestSelling: false, price: 50000, date: "2024-06-10", size: ["Small", "Medium", "Large"], onSale: true, capacity: "10L", material: "Cotton", color: ["White", "Beige"], amount: 20},
          {name: "Essentials Sling Bag", src: bag5, bestSelling: true, price: 90000, date: "2024-09-25", size: ["One Size"], onSale: false, capacity: "15L", material: "Nylon", color: ["Black", "Grey"], amount: 60},
          ...
          {name: "Essentials Clutch Bag", src: bag13, bestSelling: false, price: 50000, date: "2024-06-10", size: ["Small", "Medium", "Large"], onSale: true, capacity: "5L", material: "Cotton", color: ["White", "Beige"], amount: 20},
          {name: "Essentials Wallet Bag", src: bag14, bestSelling: true, price: 80000, date: "2024-09-10", size: ["One Size"], onSale: false, capacity: "5L", material: "Nylon", color: ["Black", "Brown"], amount: 50},
          {name: "Essentials Card Holder Bag", src: bag15, bestSelling: false, price: 60000, date: "2024-07-15", size: ["One Size"], onSale: false, capacity: "5L", material: "Nylon", color: ["Black", "Brown"], amount: 50},
          {name: "Essentials Card Holder Bag", src: bag22, bestSelling: false, price: 60000, date: "2024-07-15", size: ["One Size"], onSale: false, capacity: "5L", material: "Nylon", color: ["Black", "Brown"], amount: 50},
          {name: "Essentials Card Holder Bag", src: bag23, bestSelling: false, price: 60000, date: "2024-07-15", size: ["One Size"], onSale: false, capacity: "5L", material: "Nylon", color: ["Black", "Brown"], amount: 50},
          {name: "Essentials Card Holder Bag", src: bag24, bestSelling: false, price: 60000, date: "2024-07-15", size: ["One Size"], onSale: false, capacity: "5L", material: "Nylon", color: ["Black", "Brown"], amount: 50},
          {name: "Essentials Card Holder Bag", src: bag25, bestSelling: false, price: 60000, date: "2024-07-15", size: ["One Size"], onSale: false, capacity: "5L", material: "Nylon", color: ["Black", "Brown"], amount: 50},
    ],
    "Tops": [
    ...
    "Dresses": [
    {name: "Essentials T-Shirt", src: dress, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials Polo Shirt", src: dress2, bestSelling: false, price: 30000, date: "2024-08-15", size: ["Small", "Medium", "Large"], onSale: true, material: "Polyester", color: ["Navy Blue", "Red"], amount: 30},
    {name: "Essentials Long Sleeve Shirt", src: dress3, bestSelling: true, price: 40000, date: "2024-09-25", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 40},
    {name: "Essentials Short Sleeve Shirt", src: dress4, bestSelling: false, price: 25000, date: "2024-07-10", size: ["Small", "Medium", "Large"], onSale: true, material: "Polyester", color: ["Grey", "Blue"], amount: 20},
    {name: "Essentials Button Down Shirt", src: dress5, bestSelling: true, price: 35000, date: "2024-08-20", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Light Blue"], amount: 45},
    {name: "Essentials Henley Shirt", src: dress6, bestSelling: false, price: 28000, date: "2024-07-15", size: ["Small", "Medium", "Large"], onSale: true, material: "Polyester", color: ["Grey", "Navy Blue"], amount: 25},
    {name: "Essentials Henley Shirt", src: dress7, bestSelling: false, price: 28000, date: "2024-07-15", size: ["Small", "Medium", "Large"], onSale: true, material: "Polyester", color: ["Grey", "Navy Blue"], amount: 25},
    {name: "Essentials T-Shirt", src: dress8, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials Polo Shirt", src: dress9, bestSelling: false, price: 30000, date: "2024-08-15", size: ["Small", "Medium", "Large"], onSale: true, material: "Polyester", color: ["Navy Blue", "Red"], amount: 30},
    {name: "Essentials Long Sleeve Shirt", src: dress10, bestSelling: true, price: 40000, date: "2024-09-25", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 40},
    ...
    {name: "Essentials Polo Shirt", src: dress15, bestSelling: false, price: 30000, date: "2024-08-15", size: ["Small", "Medium", "Large"], onSale: true, material: "Polyester", color: ["Navy Blue", "Red"], amount: 30},
    {name: "Essentials Long Sleeve Shirt", src: dress16, bestSelling: true, price: 40000, date: "2024-09-25", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 40},
    {name: "Essentials Short Sleeve Shirt", src: dress17, bestSelling: false, price: 25000, date: "2024-07-10", size: ["Small", "Medium", "Large"], onSale: true, material: "Polyester", color: ["Grey", "Blue"], amount: 20},
    {name: "Essentials Button Down Shirt", src: dress18, bestSelling: true, price: 35000, date: "2024-08-20", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Light Blue"], amount: 45},
   
  ],
  "Bags":[
    {name: "Essentials T-Shirt", src: wbag19, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag2, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag3, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag4, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag5, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag6, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag7, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag8, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag9, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag10, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag11, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    ...
    {name: "Essentials T-Shirt", src: wbag15, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag16, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag17, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: wbag18, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
  ],
  "Bottoms":[
    {name: "Essentials T-Shirt", src: skirt, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt4, bestSelling: false, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt6, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt2, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt8, bestSelling: false, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt3, bestSelling: false, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    ...
    {name: "Essentials T-Shirt", src: skirt11, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt12, bestSelling: false, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt13, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt14, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt15, bestSelling: false, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt16, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt17, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt18, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
    {name: "Essentials T-Shirt", src: skirt19, bestSelling: true, price: 20000, date: "2024-09-10", size: ["Small", "Medium", "Large"], onSale: false, material: "Cotton", color: ["White", "Black"], amount: 50},
  ],
