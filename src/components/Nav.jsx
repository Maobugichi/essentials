        ...
        <div className="lg:w-[60%]  w-full flex flex-col justify-center  h-full">
          <div className="flex  lg:w-full lg:justify-end  w-[95%] mx-auto justify-between gap-6  lg:h-[80px] items-center  relative">
            ...
            <ul className="flex lg:flex-row items-center gap-2 lg:pr-6">
              <Link aria-label="link to login page" className="hidden lg:block" to="/logins/1">
                <li>
              ...
              <li onClick={() => setShowCart(!showCart)} className="relative">
                <div role="region" aria-label="cart count"  aria-live="polite" aria-atomic="true" aria-relevant="all"  className={`${cartColor} top-[-3px]   grid place-content-center right-0 absolute rounded-full w-3 h-3`}>
          ...
          >
            <div>
              <p className="cursor-poiner" onClick={handleNavigate}>New Arrivals</p>
            </div>
