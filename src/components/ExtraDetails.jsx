...
const ExtraDetails = ({quantity,setQuantity,src,setShowCart,name,color,size,price,essentials,pop,setShowPop}) => {
    ...
    <section className="h-auto  min-h-[130vh] w-[95%] mx-auto">
            <div className="h-full  flex lg:flex-row flex-col w-full gap-4 justify-center">
                ...
                <div className="lg:w-[40%]  w-full flex items-center justify-center h-auto min-h-[400px] ">   
                ...
                <div className="lg:w-[35%] w-[95%] mx-auto grid gap-4">
                    ...
                    <div className=" flex flex-col gap-5 items-center">
                        ...
                        <div>
                            <button onClick={() => setShowPop(!pop)} className="flex items-center text-sm"><svg className="w-5" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
