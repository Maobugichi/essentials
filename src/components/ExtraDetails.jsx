...
const ExtraDetails = ({quantity,setQuantity,src,setShowCart,name,color,size,price,pop,setShowPop,cartItems,setCartItems,setAlreadyAdded}) => {
  ...
  const handleAddToWishList = () => {
    ...
    const storedWishItems = getCookie("wishlist");
    if (storedWishItems) {
      ...
      <section className="h-auto  min-h-[130vh] w-[95%] mx-auto">
              <div className="h-full  flex lg:flex-row flex-col w-full gap-4 justify-center">
                  ...
                  <div className="lg:w-[40%] w-full flex items-center lg:items-start justify-center h-1/2 lg:mt-5">   
                    {imageLoaded ? ( <img className="w-[90%] lg:h-[550px]"  src={src} alt={name} />) : (<Skeleton height={200} width={200} />)}
                  </div>
                  ...
                  <div className="lg:w-[35%] w-[95%] mx-auto grid gap-4">
                      ...
                      <div className=" flex flex-col gap-5 items-center">
                          <div className="grid gap-3 w-full">
                              ...
                              <select className="w-full h-12 border pl-5 " name="color" id="color">
                          ...
                          <div className="grid gap-3 w-full">
                              ...
                              <select className="w-full h-12 border pl-5" name="cars" id="cars">
                                  {
                                      size.map((item,i) => <Option key={i} sizeOption={item}/>)
                                  }
                              </select>
                          </div>
                          ...
                          <div>
                              <button onClick={handleAddToWishList}  className="flex items-center text-sm"><svg className="w-5" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
                            ...
                            <div className="w-full">
                                <div className="border-t p-4 h-auto">
                                    ...
                                    <motion.p
                                      ...
                                      exit={{opacity:0}}
                                      className={show  ? "text-[12px] block" : "text-0 hidden"}>Click here to learn more about our return policy.
                                    </motion.p>
                                </div>
                                <div className="border-t p-4 h-auto">
