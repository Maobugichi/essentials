...
const SlideComponent = ({essentials,top,recommendations,simgHeight}) => {
    ...
    return(
        <section className={`w-full mt-9 h-auto min-h-[50vh] lg:min-h-[90vh] grid gap-7  relative ${top} `}>
            ...
            <div  ref={sliderRef}  className={` w-[90%]    mx-auto  flex flex-col gap-4 no-scrollbar`} style={{ overflow: "scroll" }}>
