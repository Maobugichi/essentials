...
const SlideComponent = ({essentials,top,recommendations,simgHeight,stop}) => {
    ...
    return(
        <section className={`w-full lg:mt-9 h-auto min-h-[50vh] mb-10 lg:min-h-[90vh] flex flex-col lg:gap-7 gap-4 justify-center  bg-yellow-300 relative ${top}  ${stop}`}>
            ...
            <div  className={` w-[90%]  mx-auto  flex flex-col gap-4  h-[95%] no-scrollbar`} style={{ overflowX: "scroll"}}>
